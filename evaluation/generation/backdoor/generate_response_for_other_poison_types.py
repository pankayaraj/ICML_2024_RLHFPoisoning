...
for idx in tqdm(range(size)):
    ...
    #THIS IS THE ONLY STEP DIFFERENT FROM RANDOM INFERENCE, Because:
    #During random poiosning there was a smaller positional difference between how triggers were added. 
    #Still triggers are added in the end. Just a smaller difference
     
    inp_c_p = dataset["clean"]["prompt"][idx]
    inp_p_p = dataset["clean"]["prompt"][idx] + " " + token
